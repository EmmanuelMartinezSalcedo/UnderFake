...
{
    public class FaceLandmarkerNoseTipDetectorSinglePlayer : VisionTaskApiRunner<FaceLandmarker>
    {
        [SerializeField] private SingleplayerPlayerController playerController;
